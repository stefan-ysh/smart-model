  ...
  return (
    <div className="p-5 space-y-5 overflow-y-auto max-h-[calc(100vh-100px)]">
      <div className="pb-3 border-b border-border/50">
        <h2 className="text-base font-semibold bg-linear-to-r from-foreground to-accent/70 bg-clip-text text-transparent">镂空板</h2>
      ...
      <MaterialSection parameters={parameters} updateParam={updateParam} showTextColor={false} />
      <LayoutSectionPanel currentMode="hollow" parameters={parameters} updateParam={updateParam} />
    </div>
  )
}
